...
date: "2026-04-07"
summary: "第三轮精进：逐位点细化事实差异，全量回填到结构化主表与筛选子表。"
tags:
  - 竞品追踪
  - 周报
  - 分期乐
...
period: "2026-W15"
highlights:
  - 已按全量位点回填，当前可比位点 19 个。
  - APP/消金主链路稳定，运营位变化更明显。
  - 风控与客服缺口仍为高优先补图项。
actions:
  - 高优先补拍风控全量位点与度小满客服0402同位点。
  - 保持同位点命名规范，避免跨期不可比。
  - 汇报默认采用筛选子表，减少全量信息干扰。
insights:
  - id: 分期乐-app-借钱
  ...
  - id: 分期乐-app-我的页面
    ...
    period: 2026-W15
    page: 我的页面
    conclusion: 我的页面位点主链路稳定，局部内容有更新。
    ...
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
    prevEvidence:
      - /evidence/分期乐-app-0323-我的页面.jpg
    currEvidence:
      - /evidence/分期乐-app-0402-我的页面.jpg
    evidence:
      - /evidence/分期乐-app-0323-我的页面.jpg
      - /evidence/分期乐-app-0402-我的页面.jpg
  - id: 分期乐-app-消息页
  ...
  - id: 分期乐-app-购物推荐页
    ...
    period: 2026-W15
    page: 购物推荐页
    conclusion: 购物推荐页基期缺图，无法完成跨期判断。
    compare: 仅有0402截图；识别信号：购物。需补拍0323同位点。
    impact: 中
    confidence: 是（建议人工复核）
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
  ...
  - id: 分期乐-app-购物页推荐
    ...
    period: 2026-W15
    page: 购物页推荐
    conclusion: 购物页推荐本期缺图，无法完成跨期判断。
    compare: 仅有0323截图；识别信号：购物。需补拍0402同位点。
    impact: 中
    confidence: 是（建议人工复核）
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
    prevEvidence:
      - /evidence/分期乐-app-0323-购物页推荐.jpg
    currEvidence:
      - 无
    evidence:
      - /evidence/分期乐-app-0323-购物页推荐.jpg
  ...
  - id: 分期乐-留存促活运营-活动弹窗
    ...
    period: 2026-W15
    page: 活动弹窗
    conclusion: 活动弹窗本期缺图，无法完成跨期判断。
    compare: 仅有0323截图；识别信号：弹窗、活动。需补拍0402同位点。
    impact: 中
    confidence: 是（建议人工复核）
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
    prevEvidence:
      - /evidence/分期乐-留存促活运营-0323-活动弹窗.jpg
    currEvidence:
      - 无
    evidence:
      - /evidence/分期乐-留存促活运营-0323-活动弹窗.jpg
  ...
  - id: 分期乐-留存促活运营-活动页
    ...
    period: 2026-W15
    page: 活动页
    conclusion: 活动页基期缺图，无法完成跨期判断。
    compare: 仅有0402截图；识别信号：活动。需补拍0323同位点。
    impact: 中
    confidence: 是（建议人工复核）
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
    prevEvidence:
      - 无
    currEvidence:
      - /evidence/分期乐-留存促活运营-0402-活动页.jpg
    evidence:
      - 无
      - /evidence/分期乐-留存促活运营-0402-活动页.jpg
  - id: 度小满-app-保险
  ...
  - id: 度小满-留存促活运营-代言人活动弹窗
    ...
    period: 2026-W15
    page: 代言人活动弹窗
    conclusion: 代言人活动弹窗基期缺图，无法完成跨期判断。
    compare: 仅有0402截图；识别信号：弹窗、活动。需补拍0323同位点。
    impact: 中
    confidence: 是（建议人工复核）
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
  ...
  - id: 度小满-留存促活运营-代言人活动落地页2
    ...
    period: 2026-W15
    page: 代言人活动落地页2
    conclusion: 代言人活动落地页2基期缺图，无法完成跨期判断。
    compare: 仅有0402截图；识别信号：活动。需补拍0323同位点。
    impact: 中
    confidence: 是（建议人工复核）
    actions:
  ...
  - id: 度小满-留存促活运营-活动浮层奖励
    ...
    period: 2026-W15
    page: 活动浮层奖励
    conclusion: 活动浮层奖励基期缺图，无法完成跨期判断。
    compare: 仅有0402截图；识别信号：活动、浮层。需补拍0323同位点。
    impact: 中
    confidence: 是（建议人工复核）
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
  ...
  - id: 度小满-留存促活运营-活动落地页
    ...
    compare: 同位点双周期可比；识别信号：活动。本期活动素材/触达形式较上期更强。
    impact: 高
    confidence: 否
    actions:
      - 按同位点继续追踪；缺图项优先补拍后再定版。
...
| 分期乐 | APP | 我的页面 | 我的页面位点主链路稳定，局部内容有更新。 | ![](/evidence/分期乐-app-0323-我的页面.jpg) | ![](/evidence/分期乐-app-0402-我的页面.jpg) | 同位点双周期均有截图；识别信号：我的。未见主流程重构，变化集中在素材与信息层。 | 中 | 否 |
...
| 分期乐 | APP | 购物推荐页 | 购物推荐页基期缺图，无法完成跨期判断。 | 无 | ![](/evidence/分期乐-app-0402-购物推荐页.jpg) | 仅有0402截图；识别信号：购物。需补拍0323同位点。 | 中 | 是（建议人工复核） |
...
| 分期乐 | APP | 购物页推荐 | 购物页推荐本期缺图，无法完成跨期判断。 | ![](/evidence/分期乐-app-0323-购物页推荐.jpg) | 无 | 仅有0323截图；识别信号：购物。需补拍0402同位点。 | 中 | 是（建议人工复核） |
...
| 分期乐 | 留存促活运营 | 活动弹窗 | 活动弹窗本期缺图，无法完成跨期判断。 | ![](/evidence/分期乐-留存促活运营-0323-活动弹窗.jpg) | 无 | 仅有0323截图；识别信号：弹窗、活动。需补拍0402同位点。 | 中 | 是（建议人工复核） |
| 分期乐 | 留存促活运营 | 活动落地页 | 活动落地页本期缺图，无法完成跨期判断。 | ![](/evidence/分期乐-留存促活运营-0323-活动落地页.jpg) | 无 | 仅有0323截图；识别信号：活动。需补拍0402同位点。 | 中 | 是（建议人工复核） |
| 分期乐 | 留存促活运营 | 活动页 | 活动页基期缺图，无法完成跨期判断。 | 无 | ![](/evidence/分期乐-留存促活运营-0402-活动页.jpg) | 仅有0402截图；识别信号：活动。需补拍0323同位点。 | 中 | 是（建议人工复核） |
...
| 度小满 | 客服 | 对话页初始 | 对话页初始本期缺图，无法完成跨期判断。 | ![](/evidence/度小满-客服-0323-对话页初始.jpg) | 无 | 仅有0323截图；识别信号：对话。需补拍0402同位点。 | 高 | 是（建议人工复核） |
...
| 度小满 | 留存促活运营 | 代言人活动弹窗 | 代言人活动弹窗基期缺图，无法完成跨期判断。 | 无 | ![](/evidence/度小满-留存促活运营-0402-代言人活动弹窗.jpg) | 仅有0402截图；识别信号：弹窗、活动。需补拍0323同位点。 | 中 | 是（建议人工复核） |
| 度小满 | 留存促活运营 | 代言人活动落地页2 | 代言人活动落地页2基期缺图，无法完成跨期判断。 | 无 | ![](/evidence/度小满-留存促活运营-0402-代言人活动落地页2.jpg) | 仅有0402截图；识别信号：活动。需补拍0323同位点。 | 中 | 是（建议人工复核） |
| 度小满 | 留存促活运营 | 活动弹窗 | 活动弹窗本期缺图，无法完成跨期判断。 | ![](/evidence/度小满-留存促活运营-0323-活动弹窗.jpg) | 无 | 仅有0323截图；识别信号：弹窗、活动。需补拍0402同位点。 | 中 | 是（建议人工复核） |
| 度小满 | 留存促活运营 | 活动浮层奖励 | 活动浮层奖励基期缺图，无法完成跨期判断。 | 无 | ![](/evidence/度小满-留存促活运营-0402-活动浮层奖励.jpg) | 仅有0402截图；识别信号：活动、浮层。需补拍0323同位点。 | 中 | 是（建议人工复核） |
| 度小满 | 留存促活运营 | 活动落地页 | 活动落地页运营触达方式发生变化，活动表达更活跃。 | ![](/evidence/度小满-留存促活运营-0323-活动落地页.jpg) | ![](/evidence/度小满-留存促活运营-0402-活动落地页.jpg) | 同位点双周期可比；识别信号：活动。本期活动素材/触达形式较上期更强。 | 高 | 否 |